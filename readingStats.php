  ...
  <body>
        ...
        <div class='collapse navbar-collapse' id='navbarColor03'>
          <ul class='navbar-nav ml-auto'>
            ...
            <li class='nav-item'>
              <a class='nav-link active' href='http://jpromano.net/stats/readingStats.php'>Reading</a>
            </li>
            <li class='nav-item'>
              ...
              echo "<th>Time</th>"; 
						...
						while ($row = $res->fetch_array()) 
							{ 
								...
								echo "<td>".$row['paginasTotales']."</td>";
                echo "<td>".$row['paginasLeidas']."</td>";
								echo "<td>".$row['tiempoLectura']." Hs</td>";
								echo "</tr>"; 
							} 
							echo "</table>"; 
							$res->free(); 
